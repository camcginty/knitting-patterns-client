...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://thawing-anchorage-62811.herokuapp.com',
...
var showPatternsTemplate = __webpack_require__(18);
var patternDisplay = __webpack_require__(35);
var authUi = __webpack_require__(6);

var error = function error(signOutError) {
  clearText();
  clearForms();
  $('.info').append("That didn't work.");
};

var createPatternSuccess = function createPatternSuccess(data) {
  clearText();
  clearForms();
  $('.patterns').hide();
...
var showPattern = function showPattern(data) {
  $('.pattern').empty();
  var patternTemplate = patternDisplay({ pattern: data.pattern });
  $('.pattern').show().append(patternTemplate);
  renewColors(data);
};

var setColors = function setColors(data) {
...
var renewColors = function renewColors(data) {
  var sqId = void 0;
  for (var i = 0; i < data.pattern.squares.length; i++) {
...
var showPatternsSuccess = function showPatternsSuccess(data) {
  clearText();
  clearForms();
  $('.pattern').hide();
  listPatterns(data);
...
var showOneSuccess = function showOneSuccess(thisPattern) {
  $('.patterns').hide();
  $('.pattern').hide();
  showPattern(thisPattern);
};

var listPatterns = function listPatterns(data) {
  $('.pattern-list').remove();
  var patternListHbs = showPatternsTemplate({ pattern: data.patterns });
  $('.patterns').append(patternListHbs);
};

var deletePatternSuccess = function deletePatternSuccess(data) {
  clearText();
  clearForms();
};
...
module.exports = {
  createPatternSuccess: createPatternSuccess,
  showPattern: showPattern,
  showPatternsSuccess: showPatternsSuccess,
  listPatterns: listPatterns,
  deletePatternSuccess: deletePatternSuccess,
  error: error,
...
var authApi = __webpack_require__(14);
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.signIn(data).then(authUi.signInSuccess).catch(authUi.error);
};
...
var signInSuccess = function signInSuccess(_signInSuccess) {
  store.user = _signInSuccess.user;
  signedIn = true;
  clearText();
  clearForms();
  $('.pre-sign-in').hide();
...
var onShowAllPatterns = function onShowAllPatterns() {
  api.showPatterns().then(ui.showPatternsSuccess).catch(ui.error);
};

var onShowOne = function onShowOne() {
  var patternId = this.parentElement.id;
  api.findPattern(patternId).then(ui.showOneSuccess).catch(ui.error);
};

var onCreatePattern = function onCreatePattern() {
  event.preventDefault();
  $('.info').append('This will take a moment...');
  var data = getFormFields(event.target);
  api.createPattern(data).then(onCreateSquares).catch(ui.error);
};

var onCreateSquares = function onCreateSquares(data) {
  var patternId = data.pattern.id;
  for (var i = 0; i < 324; i++) {
    api.createSquares(data);
  }
  api.findPattern(patternId).then(ui.showOneSuccess).then(ui.createPatternSuccess);
};

var onDeletePattern = function onDeletePattern() {
  event.preventDefault();
  var data = this.parentElement.id;
  api.deletePattern(data).then(ui.deletePatternSuccess(data)).then(onShowAllPatterns).catch(ui.error);
};
...
var onChangeColor = function onChangeColor() {
  sqId = this.id;
  ...
  api.findSquare(squareId).then(api.updateSquare(squareId, on)).then(ui.changeColor(sqId, color));
};

module.exports = {
  onCreatePattern: onCreatePattern,
  onChangeColor: onChangeColor,
  onShowAllPatterns: onShowAllPatterns,
  onShowOne: onShowOne,
...
var createPattern = function createPattern(data) {
  return $.ajax({
    method: 'POST',
...
var createSquares = function createSquares(data) {
  return $.ajax({
    method: 'POST',
...
var updatePattern = function updatePattern(patternId) {
  return $.ajax({
    method: 'PATCH',
...
var updateSquare = function updateSquare(squareId, on) {
  return $.ajax({
    method: 'PATCH',
...
var showPatterns = function showPatterns() {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/patterns',
    headers: {
...
var findPattern = function findPattern(patternId) {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/patterns/' + patternId,
    headers: {
...
var findSquare = function findSquare(squareId) {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/squares/' + squareId,
    headers: {
...
var deletePattern = function deletePattern(data) {
  return $.ajax({
    method: 'DELETE',
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.editable : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "    <li id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <button class='pattern-name'>"
  ...
  return "<h3>Your Patterns:</h3>\n<ul class='pattern-list'>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.pattern : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</ul>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "      <div class=\"col-xs-4 col-md-3 box\" id=\""
  ...
  return "  <h2 id='"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pattern : depth0)) != null ? stack1.title : stack1), depth0))
    + "'>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pattern : depth0)) != null ? stack1.title : stack1), depth0))
    + "</h2>\n  <div id='"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pattern : depth0)) != null ? stack1.id : stack1), depth0))
    + "'>\n    <div class=\"row\" id='row1'>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.pattern : depth0)) != null ? stack1.squares : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</div>\n";
},"useData":true});
...
module.exports = __webpack_require__.p + "73806eb5c1be38a2c6a172387146a207.jpg";
